    ...
    <div>
      <div className="navbar" style={styleObj}>
        ...
        <div style={styleObjUl}>
          ...
          <div style={{ 'position': 'relative', 'display': 'flex', 'flex-direction': 'column', 'align-items': 'center', 'justify-content': 'center' }}> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
            <h6 style={{ 'position': 'absolute', 'top': '0', 'left': '5px'}}>{plantsArray.length}</h6>
